...
export class CGMPSettings {
	static registerSettings() {
		game.settings.register("cautious-gamemasters-pack-2", CGMP_OPTIONS.DISABLE_GM_AS_PC, {
		...
		game.settings.register("cautious-gamemasters-pack-2", CGMP_OPTIONS.BLIND_HIDDEN_TOKENS, {
		...
		game.settings.register("cautious-gamemasters-pack-2", CGMP_OPTIONS.DISABLE_CHAT_RECALL, {
		...
		game.settings.register("cautious-gamemasters-pack-2", CGMP_OPTIONS.NOTIFY_TYPING, {
	...
	static getSetting(option) {
		return game.settings.get("cautious-gamemasters-pack-2", option);
	}
}